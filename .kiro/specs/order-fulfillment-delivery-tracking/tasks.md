...
- [x] 1. Project scaffolding and configuration
  ...
  - [x] 1.3 Configure Firebase client SDK and environment variables
  ...
  - [x] 1.5 Configure CORS middleware in Go backend
...
- [x] 2. TypeScript interfaces and Go data models
  - [x] 2.1 Define TypeScript interfaces for all domain entities
  ...
  - [x] 2.2 Define Go structs and request/response types
...
- [x] 3. UI/UX design system and shared components
  - [x] 3.1 Configure Tailwind CSS v4 theme with design tokens
  ...
  - [x] 3.2 Create shared UI components (Button, Card, Input, StatusBadge)
  ...
  - [x] 3.3 Create layout components (Sidebar, AppShell, NavigationTabs)
...
- [x] 4. Auth guard middleware and Firebase auth integration
  - [x] 4.1 Implement Go Auth Guard middleware
  ...
  - [x]* 4.2 Write property test for Auth Guard (Property 16)
  ...
  - [x] 4.3 Implement frontend AuthProvider and auth service
...
- [x] 5. Go backend router and handler structure
  - [x] 5.1 Set up HTTP router with all API endpoints
  ...
  - [x] 5.2 Create Firestore repository layer
...
- [x] 6. Order state machine implementation
  - [x] 6.1 Implement order state machine in Go
  ...
  - [x]* 6.2 Write property test for state machine (Property 4)
...
- [x] 7. Order placement and validation
  - [x] 7.1 Implement order validation in Go backend
  ...
  - [x]* 7.2 Write property test for order validation (Property 1)
  ...
  - [x] 7.3 Implement CreateOrder handler and service
  ...
  - [x]* 7.4 Write property test for order persistence (Property 3)
  ...
  - [x] 7.5 Implement frontend OrderForm component
...
- [x] 8. Stock service integration
  - [x] 8.1 Implement Stock Service in Go backend
  ...
  - [x] 8.2 Wire stock check into order creation flow
  ...
  - [x]* 8.3 Write property test for stock check outcome (Property 2)
...
- [x] 9. Checkpoint - Core order creation flow
  - Ensure all tests pass, ask the user if questions arise.

- [x] 10. Production workflow
  - [x] 10.1 Implement production status transitions in Go backend
  ...
  - [x]* 10.2 Write property test for production start metadata (Property 6)
  ...
  - [x]* 10.3 Write property test for production queue filtering (Property 5)
  ...
  - [x] 10.4 Implement frontend ProductionPage
...
- [x] 11. QC review workflow
  - [x] 11.1 Implement QC review handlers in Go backend
  ...
  - [x]* 11.2 Write property test for QC decision transitions (Property 7)
  ...
  - [x]* 11.3 Write property test for QC fail reason validation (Property 8)
  ...
  - [x] 11.4 Implement frontend QCReviewPage
...
- [x] 12. Courier assignment and dispatch
  - [x] 12.1 Implement courier assignment and dispatch handlers in Go backend
  ...
  - [x] 12.2 Implement frontend DispatchPage
...
- [x] 13. Checkpoint - Order lifecycle through dispatch
  - Ensure all tests pass, ask the user if questions arise.

- [x] 14. GPS tracking implementation
  - [x] 14.1 Implement frontend GPS Tracker service
  ...
  - [x]* 14.2 Write property test for GPS coordinate validation (Property 9)
  ...
  - [x] 14.3 Implement GPS Tracker React component
  ...
  - [x]* 14.4 Write property test for GPS staleness detection (Property 10)
  ...
  - [x] 14.5 Implement CourierMap component on dashboard
...
- [x] 15. Chunking protocol implementation
  - [x] 15.1 Implement frontend Chunk Uploader service
  ...
  - [x]* 15.2 Write property test for chunk structure invariants (Property 12)
  ...
  - [x]* 15.3 Write property test for file size rejection (Property 13)
  ...
  - [x] 15.4 Implement Go Chunk Assembler service
  ...
  - [x]* 15.5 Write property test for chunking round-trip (Property 11)
  ...
  - [x]* 15.6 Write property test for assembly guard conditions (Property 14)
...
- [x] 16. MIME validation
  - [x] 16.1 Implement MIME Validator in Go backend
  ...
  - [x]* 16.2 Write property test for MIME validation (Property 15)
...
- [x] 17. Proof of delivery (Serah-Terima)
  - [x] 17.1 Implement frontend ProofCapture component
  ...
  - [x] 17.2 Wire ProofCapture to ChunkUploader and delivery confirmation
  ...
  - [x]* 17.3 Write property test for proof capture validation (Property 18)
...
- [x] 18. Checkpoint - Delivery and file handling complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 19. Real-time monitoring dashboard
  - [x] 19.1 Implement DashboardPage with real-time order pipeline
  ...
  - [x] 19.2 Implement AnomalyAlerts component
  ...
  - [x] 19.3 Implement FilterPanel component
  ...
  - [x]* 19.4 Write property test for dashboard filter AND logic (Property 17)
  ...
  - [x] 19.5 Implement dashboard stats backend endpoint
...
- [x] 20. Firestore security rules
  - [x] 20.1 Create Firestore security rules file
...
- [x] 21. Frontend service layer and API client wiring
  - [x] 21.1 Implement frontend service layer
...
- [x] 22. App routing and page integration
  - [x] 22.1 Set up React Router with all page routes
