      ...
      tableRows.push(
        new TableRow({
          children: [
            ...
            new TableCell({ shading: { fill: 'FEF3C7' }, margins: COMPACT_CELL_MARGINS, children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: bum ? (bum.kebutuhan > 0 ? formatNum(bum.kebutuhan, 2) : '-') : '', bold: true, size: 13, font: 'Arial' })] })] }),
    ...
    poDocxRows.push(
      new TableRow({
        children: [
          ...
          new TableCell({ width: { size: 20, type: WidthType.PERCENTAGE }, shading: { fill: rowBg }, margins: COMPACT_CELL_MARGINS, children: [new Paragraph({ children: [new TextRun({ text: r.supplier || 'Koperasi Al-Umanaa', bold: true, size: 13, font: 'Arial' })] })] }),
