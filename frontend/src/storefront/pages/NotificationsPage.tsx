...
const mapOrderToNotification = (order: Order): NotificationItem => {
...
const STATIC_PROMO_NOTIFICATIONS: NotificationItem[] = [
  {
    id: "promo-1",
    type: "promo",
...
const STATIC_INFO_NOTIFICATIONS: NotificationItem[] = [
  {
    id: "info-1",
    type: "info",
...
export function NotificationsPage() {
  ...
  const getNotificationsList = (): NotificationItem[] => {
    ...
    if (activeTab === "promo") return STATIC_PROMO_NOTIFICATIONS;
